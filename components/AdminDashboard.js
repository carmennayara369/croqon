...
export default class AdminDashboard {
  ...
  getOrders() {
    try {
      const restoredDefaultOrders = [
        {
          orderId: "CRQ-172051",
          date: "29 de julio de 2026 a las 23:05",
          user: {
          ...
          delivery: {
            ...
            city: "marbella",
            postal: "29639",
            dateStr: "Vendredi 31 juillet 2026 (Logistique mardi)"
          },
          billing: {
            company: "Mariposario Melsens SL",
            address: "C. Muérdago s/n, 29639 Marbella / Málaga",
            cif: "B19433648"
          },
          payment: {
            method: "transfer",
          ...
          items: [
            ...
            },
            {
              ...
              name_en: "Iberian Bellota Chorizo",
              price: 0.95,
              units: 1,
              quantity: 100
            },
            {
              id: "manchego-serrano",
              name: "Manchego et Serrano",
              name_en: "Manchego & Serrano",
              price: 0.95,
              units: 1,
              quantity: 100
            },
            ...
            {
              id: "camaron-gris-30g",
              name: "Crevettes grises (Crevettes grises) 30g",
              name_en: "Grey Shrimp (Camarón Gris) 30g",
              price: 1.35,
              units: 1,
              quantity: 240
            }
        ...
        {
          orderId: "CRQ-167661",
          date: "29 de julio de 2026 a las 14:37",
          user: {
            name: "La Tabla Belga",
            cif: "B19846187",
          ...
          billing: {
            company: "La Tabla Belga",
            address: "Centro comercial Los Pinare, 29604 Marbella / Málaga",
            cif: "B19846187"
          },
          payment: {
            method: "transfer",
      ...
      if (!stored) {
        localStorage.setItem("croqon_b2b_orders", JSON.stringify(restoredDefaultOrders));
        return restoredDefaultOrders;
      }
      const parsed = JSON.parse(stored);
      let modified = false;
      restoredDefaultOrders.forEach(ro => {
        if (!parsed.some(o => o.orderId === ro.orderId)) {
          parsed.push(ro);
          modified = true;
        }
      });
      if (modified) {
        localStorage.setItem("croqon_b2b_orders", JSON.stringify(parsed));
      }
      return parsed;
    } catch (e) {
